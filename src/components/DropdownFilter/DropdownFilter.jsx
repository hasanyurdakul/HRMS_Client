...
function DropdownFilter({ align }) {
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={trigger}
        className="btn px-2.5 bg-white dark:bg-gray-800 border-gray-200 hover:border-gray-300 dark:border-white dark:hover:border-gray-600 text-gray-400 dark:text-gray-500"
        aria-haspopup="true"
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className={`origin-top-right z-10 absolute top-full left-0 right-auto min-w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-white pt-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${
          align === "right"
      ...
      >
        <div ref={dropdown}>
          ...
          <div className="py-2 px-3 border-t border-gray-200 dark:border-white bg-gray-50 dark:bg-gray-700/20">
            <ul className="flex items-center justify-between">
              <li>
                <button
                  onClick={handleFilters}
                  className="btn-xs bg-white dark:bg-gray-800 border-gray-200 dark:border-white hover:border-gray-300 dark:hover:border-gray-600 text-red-500"
                >
                  Clear
                </button>
              </li>
